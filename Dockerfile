...
RUN apt-get update -y && apt-get install -y munin-node telnet mtr wget dig dnsutils && apt-get clean && rm -rf /var/cache/apt/archives/* /var/lib/apt/lists/* /tmp/* /var/tmp/*
